      ...
      >
        ...
        <div
          className={`mr-4 flex h-10 w-10 items-center justify-center rounded-full font-bold ${
            active ? "bg-[#E18E47] text-white" : "bg-gray-300 text-black"
          }`}
        >
          {number}
        </div>
...
//       >
//         {/* Numbering */}
//         <div className="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-[#E18E47] text-black font-bold">
//           {number}
//         </div>
